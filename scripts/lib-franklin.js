 ...
 */
function addChevronToButtons(element, selector = 'a.button') {
 ...
 */
async function decorateHeader(block) {
  block.textContent = '';
...
export function loadHeader(header) {
  ...
  const event = new CustomEvent('block-loaded', { detail: { block: headerBlock, blockName: 'header' } });
  document.body.dispatchEvent(event);
  return decorateHeader(headerBlock);
}
